# -*- coding: utf-8 -*-
"""Template-QueryDevelopment-Turbines.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1WX1UVMCSuJmLm1-OTDrMDoN3GgJpqhGD
"""
...
scada_des_file = pd.read_csv("/content/drive/My Drive/scadadescriptions.csv", header=0)
...
scada_names_file = pd.read_csv("/content/drive/My Drive/scadanames.csv", header=0)
...
fevent_details_file = pd.read_csv("/content/drive/My Drive/faulteventdetails_latest.csv", header=0)

faultevent_details = list(fevent_details_file.Details) #descriptions for all fault events to replace <fevent-details> elements

faultevent_details

df_engcypher = pd.read_csv("/content/drive/My Drive/English-Cypher-WindTurbine-Final.csv") #Read the original English-Cypher file (before preprocessing)
...
replaced_df.to_csv("/content/drive/My Drive/Original_df_afterreplacement.csv")
...
final_paraphrased_df.to_csv('/content/drive/My Drive/Final_Paraphrased_WindTurbine-Latest.csv')